...
urlpatterns = [
    ...
    path('api/v1/categories/',
         views.CategoryCreateListAPIVew.as_view(), name="category_create_list_api_view"),
    path('api/v1/categories/<int:pk>/',
         views.CategoryRetrieveUpdateDestroyAPIView.as_view(), name="category_detail_api_view"),
