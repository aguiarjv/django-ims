...
urlpatterns = [
    ...
    path('brands/<int:pk>/detail/',
         views.BrandDetailView.as_view(), name="brand_detail"),
    ...
    path('api/v1/brands/',
         views.BrandCreateListAPIVew.as_view(), name="brand_create_list_api_view"),
    path('api/v1/brands/<int:pk>/',
         views.BrandRetrieveUpdateDestroyAPIView.as_view(), name="brand_detail_api_view"),
]
