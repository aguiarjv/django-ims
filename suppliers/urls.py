...
urlpatterns = [
    ...
    path('api/v1/suppliers/',
         views.SupplierCreateListAPIVew.as_view(), name="supplier_create_list_api_view"),
    path('api/v1/suppliers/<int:pk>/',
         views.SupplierRetrieveUpdateDestroyAPIView.as_view(), name="supplier_detail_api_view"),
